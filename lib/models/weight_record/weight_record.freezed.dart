...
class _$WeightRecordImpl implements _WeightRecord {
  ...
  @override
  String toString() {
    return 'WeightRecord(id: $id, animalId: $animalId, dateUtc: $dateUtc, weight: $weight, createdAtUtc: $createdAtUtc, updatedAtUtc: $updatedAtUtc, createdByUserId: $createdByUserId, updatedByUserId: $updatedByUserId, rowVersion: $rowVersion, isDeleted: $isDeleted, syncStatus: $syncStatus, lastSyncedAtUtc: $lastSyncedAtUtc)';
  }
...
abstract class _WeightRecord implements WeightRecord {
  const factory _WeightRecord(
      ...
      final bool isDeleted,
      final String syncStatus,
      final int? lastSyncedAtUtc}) = _$WeightRecordImpl;
